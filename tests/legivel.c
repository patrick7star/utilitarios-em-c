...
static const size_t MILHAR     = 1e3;
static const size_t MILHAO     = 1e6;
static const size_t BILHAO     = 1e9;
static const size_t TRILHAO    = (size_t)1e12;
static const size_t QUADRILHAO = (size_t)1e15;
static const size_t QUINTILHAO = (size_t)1e18;
// para comparação ...
static const double NANOSEG    = 1e-9;
static const double MICROSEG   = 1e-6;
static const double MILISEG    = 1e-3;
static const double MINUTO     = 60.0;
static const double HORA       = 60 * MINUTO; 
static const double DIA        = 24 * HORA;
static const double MES        = 30 * DIA;
static const double ANO        = 365 * DIA;
static const double DECADA     = 10 * ANO;
static const double SECULO     = 100 * ANO;
static const double MILENIO    = 1000 * ANO;
