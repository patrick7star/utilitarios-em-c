...
# define TEXTO_PONTO_H
   /* Representação das coordenadas 'y' e 'x',
    * nesta ordem. */
   ...
   /* Operações básicas sobre o 'Ponto'. Como
    * comparação, e etc.
    * As comparações abaixo partem de um ponto simples, onde para
    * ser menor ou maior, o ponto tem que está fora do retângulo
    * formado pelo primeiro ponto. Como assim?! Bem, imagine que 
    * o canto superior esquerdo é o ponto zero de um plano cartesiano,
    * então um ponto A qualquer, no quadrante positivo está nas 
    * coordenadas(y=5, x=3), se outro ponto também no quadrante positivo,
    * estiver dentro ou nos limites do retângulo 3x5, então ele é 
    * menor ou igual, caso contrário, o oposto.
    */
   // verifica se o ponto A é menor ou igual ao ponto B.
   extern bool eq_ponto(Ponto, Ponto); 
   // apenas se é menor.
   extern bool lt_ponto(Ponto, Ponto); 
   // verifica se o ponto A é maior que B.
   extern bool gt_ponto(Ponto, Ponto);
