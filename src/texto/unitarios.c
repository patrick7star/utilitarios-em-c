...
#if defined(_UT_TEXTO)

// seus módulos para realizar os testes abaixos:
#include "../teste.h"
#include "../aleatorio.h"
...
void main(int qtd, char** args, char* vars[]) {
   executa_testes(
      5, metodos_de_visualizacao_da_matriz_texto, true,
      preenchendo_toda_matriz_texto_randomicamente, false,
      conversao_para_string, true,
      formato_string_dos_pontos, true
   );
}
#endif
