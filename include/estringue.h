...
#ifndef __ESTRINGUE_H__
#define __ESTRINGUE_H__
#include <wchar.h>
#include <stdbool.h>

 // Tupla contendo array de strings e a quantia disto.
 typedef struct { char** lista; size_t total; } ListaStrings, ListStr;
 ...
 /* Visualização debug da tupla-lista de strings. */
 void debug_lista_strings(ListaStrings*);

 // Retorna todas strings representando palavras(entre espaços).
 ListStr palavras(char*);
 // Retorna tupla com strings entre quebra-de-linhas.
 ListStr split_lines             (const char* In);
 ListStr split_at                (const char* In, const char PADRAO);
 ListStr split_ascii_whitespace  (const char* In);
 ListStr split_once              (const char* In, const char PADRAO);


/* == == == == == == == == == == == == == == == == == == == == == == == == ==
 *                      Estrutura Mutável String
 * == == == == == == == == == == == == == == == == == == == == == == === = */
 ...
 * == == == == == == == == == == == == == == == == == == == == == == === = */
 ...
 ListStr reparte_ascii          (char* s, char* p);
